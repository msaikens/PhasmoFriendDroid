...
enum class BehaviorTag(@StringRes val labelResId: Int) {
    ...
    CALM_THEN_AGGRESSIVE_CYCLES(R.string.behavior_calm_aggressive_alternating),
    ...
    HUNTS_LESS_AGGRESSIVE_AS_SANITY_DROPS(R.string.PROTECTIVE_EQUIPMENT_ENRAGES),
    LATE_HUNTER(R.string.behavior_late_hunter),
    LINE_OF_SIGHT_SPEED_UP(R.string.behavior_line_of_sight_speed_up),
    MOVES_FASTER_WHEN_PLAYER_MOVES_NEARBY(R.string.MOVEMENT_SPEED_CHANGES_WHEN_PLAYER_MOVES),
    PROTECTIVE_EQUIPMENT_BETTER_AS_GHOST_WEAKENS(R.string.WEAKER_MORE_IMPACTED_BY_PROTECTIVE),
    ...
    SELECTIVELY_STEPS_IN_SALT(R.string.SELECTIVE_SALT_DISTURBANCE),
